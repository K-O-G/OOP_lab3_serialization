...
namespace SOAP
{
    ...
    class ProductSOAP
    {
        ...
        public ProductSOAP(int code, string name, string producer, int price, int amount)
        {
            this.code = code;
            this.name = name;
        ...
        public ProductSOAP(SerializationInfo info, StreamingContext context)
        {
    ...
    class CompareClasse : IComparer<ProductSOAP>
    {
        public int Compare(ProductSOAP x, ProductSOAP y)
        {
